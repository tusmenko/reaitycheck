...
const tabsListVariants = cva(
  "border-4 border-black p-[3px] group-data-[orientation=horizontal]/tabs:h-9 " +
  "data-[variant=line]:border-0 data-[variant=line]:border-b-4 group/tabs-list text-muted-foreground " +
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "focus-visible:outline-ring text-foreground/60 hover:text-foreground " +
