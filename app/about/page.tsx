  ...
  return (
    <div className="relative min-h-screen bg-background">
      ...
      ">
        ...
        <article className="
          relative z-10 mx-auto w-full max-w-3xl rounded-3xl border
        ...
        ">
          ...
          <p className="mt-4 text-lg/relaxed text-gray-400">
          ...
          <p className="mt-3 leading-relaxed text-gray-400">
            ...
            <a
              ...
              rel="noreferrer"
              className="
                font-medium text-accent-orange transition-colors
